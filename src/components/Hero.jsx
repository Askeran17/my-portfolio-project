        ...
        <div className="flex flex-wrap lg:flex-row-reverse">
            ...
            <div className="w-full lg:w-1/2"> 
                <motion.div 
                    ...
                    className="pb-2 text-4xl tracking-tighter lg:text-8xl">Mikhail Atayev</motion.h2>
                    <motion.span 
                    variants={childVariants}
                    ...
                    <motion.a 
                    variants={childVariants}
                    href="/resume.pdf" target="_blank" rel="noopener noreferrer" download className="bg-white rounded-full p-4 text-sm text-stone-800 mb-10">Download Resume</motion.a>
                </motion.div>
            </div>
        </div>
    </div>
